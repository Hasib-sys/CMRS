...
export class VicService{
    ...
    //1. see profile
    constructor(@InjectRepository(VictimEntity)
    private vicRepo: Repository<VictimEntity> ,
...
// }
    //validation 
   async addVic(data:VicDTO):Promise<VictimEntity>{
...
//4. Post complain 
 ...
 async getComById( id : number):Promise<VictimEntity[]> {
