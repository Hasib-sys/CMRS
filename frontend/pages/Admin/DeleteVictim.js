...
export default function DeleteVictim() {
  ...
  return (
    <>
      ...
      <h1  className="text-center text-2xl font-bold mb-4">Delete Victim Page</h1>
        <form onSubmit={handleSubmit} class="max-w-lg mx-auto">
        <div  class="form-group">
            <label htmlFor="id" class="block mb-2 text-sm font-medium text-green-700 dark:text-green-500">id:</label>
            <input
              type="number"
              id="id"
              value={id}
